...
module.exports.handleEvent = async function ({ api, event }) {
  ...
  if (!photoUrl) {
    api.sendMessage("•┄┅════❁🌺❁════┅┄•\n\nআসসালামু আলাইকুম-!!🖤💫\nআপনি যেই ছবি enhance করতে চান সেই ছবি টি দিয়ে রিপ্লাই sms দিন\n\n•┄┅════❁🌺❁════┅┄•", threadID, messageID);
    return;
  }

  api.sendMessage("╭•┄┅════❁🌺❁════┅┄•╮\n\n অপেক্ষা করুন আপনার  ছোবি টি enhance তে রুপান্তরিত করা হচ্ছে-!!⌛\n\n╰•┄┅════❁🌺❁════┅┄•╯", threadID, async () => {
    try {
      ...
      api.sendMessage({
        body: "╭•┄┅════❁🌺❁════┅┄•╮\n\nআপনার ছবি টি  enhanced পরিবর্তন করা হলো\n\n╰•┄┅════❁🌺❁════┅┄•╯",
